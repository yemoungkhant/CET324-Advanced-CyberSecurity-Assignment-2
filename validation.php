...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $enteredCode = mysqli_real_escape_string($conn, $_POST['validation_code']);
    $storedCode = $_SESSION['validation_code'];

    if ($enteredCode == $storedCode) {
        $sql = "SELECT email FROM users WHERE validation_code = ?";
...
<body>
    <div class="container">
        <form action="validation.php" method="post">
            <h2 style="text-align: center;">Validation Code</h2>
            <br>
            <div class="form-group">
                <input type="text" class="form-control" name="validation_code" placeholder="Validation Code:">
